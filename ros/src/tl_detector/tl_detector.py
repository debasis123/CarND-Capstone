...
class TLDetector(object):
    def __init__(self):
        ...
        rospy.loginfo("tl_detector node is initialized")
        ...
        # params from the ros params server
        ...
        # index of the nearest waypoint to traffic light is published
    ...
    def get_light_state(self, light):
        ...
        """
        # for testing, just return the light state from the simulator
        return light.state
